...
class MainWindow(QMainWindow):
    ...
    def __init__(self, database, transport, keys):
        ...
        self.ui.add_contact_menu.triggered.connect(self.add_contact_window)

        # Удалить контакт
        self.ui.delete_contact_button.clicked.connect(self.delete_contact_window)
        self.ui.delete_contact_button_2.triggered.connect(self.delete_contact_window)
    ...
    def set_disabled_input(self):
        ...
        # Надпись  - получатель.
        self.ui.label_input_mrssege.setText('Для выбора получателя дважды кликните на нем в окне контактов.')
        self.ui.input_mrssege.clear()
        if self.history_model:
            self.history_model.clear()

        # Поле ввода и кнопка отправки неактивны до выбора получателя.
        # self.ui.btn_clear.setDisabled(True)
        self.ui.send_message_button.setDisabled(True)
        self.ui.input_mrssege.setDisabled(True)
    ...
    def history_list_update(self):
        ...
        for i in range(start_index, length):
            ...
            if item[1] == 'in':
                ...
                self.history_model.appendRow(mess)
        self.ui.contacts.scrollToBottom()
    ...
    def set_active_user(self):
        ...
        self.ui.label_input_mrssege.setText(
            f'Введите сообщенние для {self.current_chat}:')
        self.ui.send_message_button.setDisabled(False)
        self.ui.input_mrssege.setDisabled(False)
    ...
    def send_message(self):
        ...
        message_text = self.ui.input_mrssege.toPlainText()
        self.ui.input_mrssege.clear()
        if not message_text:
            return
        try:
